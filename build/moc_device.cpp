...
#include "../source/bluetooth/device.h"
...
QT_MOC_LITERAL(16, 240, 20), // "hostModeStateChanged"
QT_MOC_LITERAL(17, 261, 31) // "QBluetoothLocalDevice::HostMode"
...
void DeviceDiscoveryDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DeviceDiscoveryDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 8: _t->hostModeStateChanged((*reinterpret_cast< QBluetoothLocalDevice::HostMode(*)>(_a[1]))); break;
        default: ;
        }
...
QT_INIT_METAOBJECT const QMetaObject DeviceDiscoveryDialog::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_DeviceDiscoveryDialog.data,
    qt_meta_data_DeviceDiscoveryDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
