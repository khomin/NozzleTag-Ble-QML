...
#include "../source/bluetooth/service.h"
...
void ServiceDiscoveryDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ServiceDiscoveryDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ServiceDiscoveryDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ServiceDiscoveryDialog.data,
    qt_meta_data_ServiceDiscoveryDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
